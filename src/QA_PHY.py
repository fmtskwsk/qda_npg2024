...
def make_data(BIT_NUM, SCALING_FACTOR, NUM_READS) :
    VAL_NUM = 40
    ...
    np.save("./data/TIME_PHY", (execution_time / 1000.) / WINDOW_NUM)
    np.save("./data/dx_opt_PHY", dx_opt)


args = get_args()
make_data(BIT_NUM=args.bit_num, SCALING_FACTOR=args.scaling_factor, NUM_READS=args.num_reads)