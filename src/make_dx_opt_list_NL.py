...
class VariationalMethod(DataAssimilation) :
    ...
    def four_d_var_increment(self) :
        ...
        optimal_solution = minimize(cost_function, dx_opt, args=(window_init_index, window_next_index), jac=jacobian, method="BFGS", callback=callback_dx)
    ...
    def make_data(self) :
        np.save('./data/dx_opt_list_NL', self.dx_opt_list)
